...
async def main():
	...
	try:
		...
		# Set viewport size
		logger.info('Setting viewport to 1920x1080...')
		...
		try:
			...
			if links:
				...
				logger.info('Clicking the link with robust fallbacks...')
			...
			logger.warning(f'Link interaction failed: {e}')
		...
		logger.info('Testing mouse operations...')
		...
		logger.info('Testing browser back navigation...')
		try:
			await page.go_back()
